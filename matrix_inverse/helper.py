...
# b = [0, -4]
m = 9
a = [[random.randrange(m),random.randrange(m)], [random.randrange(m), random.randrange(m)]]
b = [random.randrange(m), random.randrange(m)]
n = len(a)
indx = [None] * n
